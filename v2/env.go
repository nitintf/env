...
func String2(name string, defaultValue string) *string {
	v := new(string)
...
func Int2(name string, defaultValue int) *int {
	v := new(int)
...
func Bool2(name string, defaultValue bool) *bool {
	v := new(bool)
...
func Float642(name string, defaultValue float64) *float64 {
	v := new(float64)
